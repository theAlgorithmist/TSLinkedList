 ...
 */
 ...
 export class TSMT$LinkedList
 {
   ...
   *
   * @return Nothing Sets the list type only for valid values, otherwise list type remains unchanged.  A type change will automatically alter the current linkage.
   */
